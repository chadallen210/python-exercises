...
fruits_with_more_than_5 = [fruit for fruit in fruits if len(fruit) > 5]

# Exercise 6 - make a list that contains each fruit with exactly 5 characters

fruits_with_5 = [fruit for fruit in fruits if len(fruit) == 5]

# Exercise 7 - Make a list that contains fruits that have less than 5 characters

fruits_with_less_than_5 = [fruit for fruit in fruits if len(fruit) < 5]
...
# Exercise 12 - Make a variable named positive_numbers that holds only the positive 
# numbers

positive_numbers = [number for number in numbers if number > 0]

# Exercise 13 - Make a variable named negative_numbers that holds only the negative 
# numbers
...
number_with_more_than_2_digits = [number for number in numbers if number >= 10 or number <= -10]

number_with_more_than_2_digits = [number for number in numbers if len(str(abs(number))) >= 2]
...
primes = [number for number in numbers if all(number % num != 0 for num in range(2, number)) and  number > 0]
